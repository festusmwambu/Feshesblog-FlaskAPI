"""
Welcome to the documentation for the Feshesblog-FlaskAPI!

This project is written in Python, with the [Flask](https://flask.palletsprojects.com/) web framework. 
This documentation is generated automatically from the 
[project's source code](https://github.com/festusmwambu/Feshesblog-FlaskAPI) using
the [APIFairy](https://github.com/miguelgrinberg/apifairy) Flask extension.

## Introduction

Feshesblog-FlaskAPI is an easy to use web API for creating blogs. It is an ideal
...
Feshesblog-FlaskAPI provides all the base features required to implement a blog project:
...
If you are running Feshesblog-FlaskAPI yourself while developing your front end,
...
`.env` file in the project's root directory. The following table lists all the
